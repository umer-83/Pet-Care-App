...
class _DetailState extends State<Detail> {
            ...
            widget.screen == "service" ? Container(
              ...
              child: SizedBox(child: Column(
                children: [
                  ...
                  request.payment != "pending" || request.request != "accepted" ? payment(request) : SizedBox(
                    height: height1 * 0.03,
                    width: width1*0.15,
                    child: RaisedButton(
                      color: Colors.white,
                          ...
                          actions: [
                            ...
                            SizedBox(
                              ...
                              child: RaisedButton(
                                padding: EdgeInsets.all(0),
                                  onPressed: (){
                                    FirebaseFirestore.instance.collection("appointment").doc(user?.uid).collection("appointments").doc(request.documentId).update({'payment' : "accepted", "confirmPayment" : "no"});
                                    Navigator.pop(context);
                                  },
                                  child: Ink(
                                    decoration: BoxDecoration(
  ...
  Widget payment(request){
    return request.confirmPayment == "no" ? SizedBox(
      height: height1 * 0.03,
      width: width1*0.24,
      child: RaisedButton(
        color: Colors.white,
            ...
            actions: [
              SizedBox(
                ...
                child: RaisedButton(
                    padding: EdgeInsets.all(0),
                    onPressed: (){
                      FirebaseFirestore.instance.collection("appointment").doc(user?.uid).collection("appointments").doc(request.documentId).update({'confirmPayment' : "yes", "review" : review.text});
                      Navigator.pop(context);
                    },
                    child: Ink(
                      decoration: BoxDecoration(
                      ...
                      child: Container(
                        ...
                        width: width1*0.24,
                        child: Center(
                          child: FittedBox(child: Text("Confirm payment",style: TextStyle(color: Colors.white),)),
                        ),
                      ),
                    )),
              ),
